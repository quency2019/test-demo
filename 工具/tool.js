// https://mp.weixin.qq.com/s/i7JJtDg6zUvwoGi05FrEGw
...
console.log('navigator.userAgent.toLowerCase()', ua)
// 是否是微信浏览器
...
// 在字符串中查找给定单词，并且替换为另一词汇。
export const findAndReplace=(string,wordToFind,wordToReplace)=>{
